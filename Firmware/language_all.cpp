...
const char * const MSG_CRASHDETECT_NA_LANG_TABLE[LANG_NUM] PROGMEM = {
...
const char * const MSG_EXTRUDER_CORRECTION_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_EXTRUDER_CORRECTION_EN
};

const char MSG_EXTRUDER_CORRECTION_OFF_EN[] PROGMEM = "  [off";
const char * const MSG_EXTRUDER_CORRECTION_OFF_LANG_TABLE[LANG_NUM] PROGMEM = {
...
const char * const MSG_STEPPER_TIMER_OVERFLOW_ERROR_LANG_TABLE[LANG_NUM] PROGMEM = {
...
const char * const MSG_TEMP_CAL_WARNING_LANG_TABLE[LANG_NUM] PROGMEM = {
