...
const char * const MSG_SOUND_MODE_LOUD_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_SOUND_MODE_LOUD_EN
};

const char MSG_SOUND_MODE_MUTE_EN[] PROGMEM = "Sound      [mute]";
const char * const MSG_SOUND_MODE_MUTE_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_SOUND_MODE_MUTE_EN
};

const char MSG_SOUND_MODE_ONCE_EN[] PROGMEM = "Sound      [once]";
const char * const MSG_SOUND_MODE_ONCE_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_SOUND_MODE_ONCE_EN
};

const char MSG_SOUND_MODE_SILENT_EN[] PROGMEM = "Sound    [silent]";
const char * const MSG_SOUND_MODE_SILENT_LANG_TABLE[LANG_NUM] PROGMEM = {
