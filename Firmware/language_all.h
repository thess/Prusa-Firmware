...
extern const char* const MSG_BED_HEATING_SAFETY_DISABLED_LANG_TABLE[1];
#define MSG_BED_HEATING_SAFETY_DISABLED LANG_TABLE_SELECT_EXPLICIT(MSG_BED_HEATING_SAFETY_DISABLED_LANG_TABLE, 0)
...
extern const char* const MSG_CHANGED_BOTH_LANG_TABLE[1];
#define MSG_CHANGED_BOTH LANG_TABLE_SELECT_EXPLICIT(MSG_CHANGED_BOTH_LANG_TABLE, 0)
extern const char* const MSG_CHANGED_MOTHERBOARD_LANG_TABLE[1];
#define MSG_CHANGED_MOTHERBOARD LANG_TABLE_SELECT_EXPLICIT(MSG_CHANGED_MOTHERBOARD_LANG_TABLE, 0)
extern const char* const MSG_CHANGED_PRINTER_LANG_TABLE[1];
#define MSG_CHANGED_PRINTER LANG_TABLE_SELECT_EXPLICIT(MSG_CHANGED_PRINTER_LANG_TABLE, 0)
...
extern const char* const MSG_FILAMENT_SENSOR_LANG_TABLE[1];
#define MSG_FILAMENT_SENSOR LANG_TABLE_SELECT_EXPLICIT(MSG_FILAMENT_SENSOR_LANG_TABLE, 0)
...
extern const char* const MSG_FORCE_SELFTEST_LANG_TABLE[1];
#define MSG_FORCE_SELFTEST LANG_TABLE_SELECT_EXPLICIT(MSG_FORCE_SELFTEST_LANG_TABLE, 0)
...
#define MSG_LANGUAGE_NAME_EXPLICIT(LANG) LANG_TABLE_SELECT_EXPLICIT(MSG_LANGUAGE_NAME_LANG_TABLE, 0)
...
#define MSG_LANGUAGE_SELECT_EXPLICIT(LANG) LANG_TABLE_SELECT_EXPLICIT(MSG_LANGUAGE_SELECT_LANG_TABLE, 0)
...
extern const char* const MSG_SELFTEST_CHECK_FSENSOR_LANG_TABLE[1];
#define MSG_SELFTEST_CHECK_FSENSOR LANG_TABLE_SELECT_EXPLICIT(MSG_SELFTEST_CHECK_FSENSOR_LANG_TABLE, 0)
...
extern const char* const MSG_SELFTEST_EXTRUDER_FAN_SPEED_LANG_TABLE[1];
#define MSG_SELFTEST_EXTRUDER_FAN_SPEED LANG_TABLE_SELECT_EXPLICIT(MSG_SELFTEST_EXTRUDER_FAN_SPEED_LANG_TABLE, 0)
...
extern const char* const MSG_SELFTEST_FANS_LANG_TABLE[1];
#define MSG_SELFTEST_FANS LANG_TABLE_SELECT_EXPLICIT(MSG_SELFTEST_FANS_LANG_TABLE, 0)
...
extern const char* const MSG_SELFTEST_FILAMENT_SENSOR_LANG_TABLE[1];
#define MSG_SELFTEST_FILAMENT_SENSOR LANG_TABLE_SELECT_EXPLICIT(MSG_SELFTEST_FILAMENT_SENSOR_LANG_TABLE, 0)
...
extern const char* const MSG_SELFTEST_PRINT_FAN_SPEED_LANG_TABLE[1];
#define MSG_SELFTEST_PRINT_FAN_SPEED LANG_TABLE_SELECT_EXPLICIT(MSG_SELFTEST_PRINT_FAN_SPEED_LANG_TABLE, 0)
...
extern const char* const MSG_SELFTEST_SWAPPED_LANG_TABLE[1];
#define MSG_SELFTEST_SWAPPED LANG_TABLE_SELECT_EXPLICIT(MSG_SELFTEST_SWAPPED_LANG_TABLE, 0)
...
extern const char* const MSG_STEALTH_MODE_OFF_LANG_TABLE[1];
#define MSG_STEALTH_MODE_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_STEALTH_MODE_OFF_LANG_TABLE, 0)
extern const char* const MSG_STEALTH_MODE_ON_LANG_TABLE[1];
#define MSG_STEALTH_MODE_ON LANG_TABLE_SELECT_EXPLICIT(MSG_STEALTH_MODE_ON_LANG_TABLE, 0)
